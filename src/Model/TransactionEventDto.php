...
class TransactionEventDto implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    public const CARD_PROCESSOR_RESPONSE_ALL_GOOD = 'ALL_GOOD';
    public const CARD_PROCESSOR_RESPONSE_REFER_TO_ISSUER = 'REFER_TO_ISSUER';
    public const CARD_PROCESSOR_RESPONSE_INVALID_MERCHANT = 'INVALID_MERCHANT';
    public const CARD_PROCESSOR_RESPONSE_CAPTURE_CARD = 'CAPTURE_CARD';
    public const CARD_PROCESSOR_RESPONSE_DO_NOT_HONOR = 'DO_NOT_HONOR';
    public const CARD_PROCESSOR_RESPONSE_UNSPECIFIED_ERROR = 'UNSPECIFIED_ERROR';
    public const CARD_PROCESSOR_RESPONSE_HONOR_WITH_IDENTIFICATION = 'HONOR_WITH_IDENTIFICATION';
    public const CARD_PROCESSOR_RESPONSE_PARTIAL_APPROVAL = 'PARTIAL_APPROVAL';
    public const CARD_PROCESSOR_RESPONSE_INVALID_TRANSACTION = 'INVALID_TRANSACTION';
    public const CARD_PROCESSOR_RESPONSE_INVALID_AMOUNT = 'INVALID_AMOUNT';
    public const CARD_PROCESSOR_RESPONSE_INVALID_CARD_NUMBER = 'INVALID_CARD_NUMBER';
    public const CARD_PROCESSOR_RESPONSE_CARD_SCHEME_NETWORK_CANNOT_CONNECT_TO_THREDD = 'CARD_SCHEME_NETWORK_CANNOT_CONNECT_TO_THREDD';
    public const CARD_PROCESSOR_RESPONSE_CUSTOMER_CANCELLATION = 'CUSTOMER_CANCELLATION';
    public const CARD_PROCESSOR_RESPONSE_FATAL_ERROR = 'FATAL_ERROR';
    public const CARD_PROCESSOR_RESPONSE_PARTIAL_REVERSAL = 'PARTIAL_REVERSAL';
    public const CARD_PROCESSOR_RESPONSE_EXPIRED_CARD_CAP = 'EXPIRED_CARD_CAP';
    public const CARD_PROCESSOR_RESPONSE_SUSPECTED_FRAUD = 'SUSPECTED_FRAUD';
    public const CARD_PROCESSOR_RESPONSE_LOST_CARD_CAP = 'LOST_CARD_CAP';
    public const CARD_PROCESSOR_RESPONSE_STOLEN_CARD_CAP = 'STOLEN_CARD_CAP';
    public const CARD_PROCESSOR_RESPONSE_CLOSED_ACCOUNT = 'CLOSED_ACCOUNT';
    public const CARD_PROCESSOR_RESPONSE_INSUFFICIENT_FUNDS = 'INSUFFICIENT_FUNDS';
    public const CARD_PROCESSOR_RESPONSE_EXPIRED_CARD = 'EXPIRED_CARD';
    public const CARD_PROCESSOR_RESPONSE_TRANSACTION_NOT_PERMITTED_TO_HOLDER = 'TRANSACTION_NOT_PERMITTED_TO_HOLDER';
    public const CARD_PROCESSOR_RESPONSE_TRANSACTION_NOT_PERMITTED_TO_TERMINAL = 'TRANSACTION_NOT_PERMITTED_TO_TERMINAL';
    public const CARD_PROCESSOR_RESPONSE_EXCEEDED_WITHDRAW_AMOUNT_LIMIT = 'EXCEEDED_WITHDRAW_AMOUNT_LIMIT';
    public const CARD_PROCESSOR_RESPONSE_SECURITY_VIOLATION = 'SECURITY_VIOLATION';
    public const CARD_PROCESSOR_RESPONSE_EXCEEDED_WITHDRAWAL_FREQUENCY_LIMIT = 'EXCEEDED_WITHDRAWAL_FREQUENCY_LIMIT';
    public const CARD_PROCESSOR_RESPONSE_RESPONSE_RECEIVED_TOO_LATE = 'RESPONSE_RECEIVED_TOO_LATE';
    public const CARD_PROCESSOR_RESPONSE_HOLDER_TO_CONTACT_ISSUER = 'HOLDER_TO_CONTACT_ISSUER';
    public const CARD_PROCESSOR_RESPONSE_ALLOWED_PIN_RETRIES_EXCEEDED = 'ALLOWED_PIN_RETRIES_EXCEEDED';
    public const CARD_PROCESSOR_RESPONSE_ALLOWED_NUMBER_OF_PIN_TRIES_EXCEEDED = 'ALLOWED_NUMBER_OF_PIN_TRIES_EXCEEDED';
    public const CARD_PROCESSOR_RESPONSE_ISSUER_DOES_NOT_PARTICIPATE_IN_THE_SERVICE = 'ISSUER_DOES_NOT_PARTICIPATE_IN_THE_SERVICE';
    public const CARD_PROCESSOR_RESPONSE_CARD_IS_NOT_ACTIVE = 'CARD_IS_NOT_ACTIVE';
    public const CARD_PROCESSOR_RESPONSE_UNACCEPTABLE_PIN = 'UNACCEPTABLE_PIN';
    public const CARD_PROCESSOR_RESPONSE_DOMESTIC_DEBIT_TRANSACTION_NOT_ALLOWED = 'DOMESTIC_DEBIT_TRANSACTION_NOT_ALLOWED';
    public const CARD_PROCESSOR_RESPONSE_TIMEOUT_AT_IEM = 'TIMEOUT_AT_IEM';
    public const CARD_PROCESSOR_RESPONSE_APPROVED_NON_FINANCIAL_OR_HOLD = 'APPROVED_NON_FINANCIAL_OR_HOLD';
    public const CARD_PROCESSOR_RESPONSE_PIN_VALIDATION_NOT_POSSIBLE = 'PIN_VALIDATION_NOT_POSSIBLE';
    public const CARD_PROCESSOR_RESPONSE_PURCHASE_AMOUNT_ONLY_NO_CASHBACK_ALLOWED = 'PURCHASE_AMOUNT_ONLY_NO_CASHBACK_ALLOWED';
    public const CARD_PROCESSOR_RESPONSE_CRYPTOGRAPHIC_FAILURE = 'CRYPTOGRAPHIC_FAILURE';
    public const CARD_PROCESSOR_RESPONSE_AUTHENTICATION_FAILURE = 'AUTHENTICATION_FAILURE';
    public const CARD_PROCESSOR_RESPONSE_ISSUER_INOPERATIVE = 'ISSUER_INOPERATIVE';
    public const CARD_PROCESSOR_RESPONSE_CANT_ROUTE = 'CANT_ROUTE';
    public const CARD_PROCESSOR_RESPONSE_VIOLATION_OF_LAW = 'VIOLATION_OF_LAW';
    public const CARD_PROCESSOR_RESPONSE_DUPLICATE_TRANSMISSION = 'DUPLICATE_TRANSMISSION';
    public const CARD_PROCESSOR_RESPONSE_SYSTEM_MALFUNCTION = 'SYSTEM_MALFUNCTION';
    public const CARD_PROCESSOR_RESPONSE_CVV_FAIL = 'CVV_FAIL';
    public const CARD_PROCESSOR_RESPONSE_FORCE_STIP = 'FORCE_STIP';
    public const CARD_PROCESSOR_RESPONSE_APPROVE_LOAD = 'APPROVE_LOAD';
    public const CARD_PROCESSOR_RESPONSE_VERIFICATION_DATA_FAILED = 'VERIFICATION_DATA_FAILED';
    public const CARD_PROCESSOR_RESPONSE_STRONG_CUSTOMER_AUTHENTICATION = 'STRONG_CUSTOMER_AUTHENTICATION';
    public const CARD_PROCESSOR_RESPONSE_SCA_REQUIRED = 'SCA_REQUIRED';
    public const CARD_PROCESSOR_RESPONSE_CVV2_FAILURE = 'CVV2_FAILURE';
    public const CARD_PROCESSOR_RESPONSE_UNKNOWN_REASON = 'UNKNOWN_REASON';
     ...
     * @return string[]
     */
    public static function getCardPreferenceOutcomeAllowableValues()
    {
        return [
     ...
     * @return string[]
     */
    public static function getCardProcessorResponseAllowableValues()
    {
        return [
            ...
            self::CARD_PROCESSOR_RESPONSE_ALL_GOOD,
            self::CARD_PROCESSOR_RESPONSE_REFER_TO_ISSUER,
            self::CARD_PROCESSOR_RESPONSE_INVALID_MERCHANT,
            self::CARD_PROCESSOR_RESPONSE_CAPTURE_CARD,
            self::CARD_PROCESSOR_RESPONSE_DO_NOT_HONOR,
            self::CARD_PROCESSOR_RESPONSE_UNSPECIFIED_ERROR,
            self::CARD_PROCESSOR_RESPONSE_HONOR_WITH_IDENTIFICATION,
            self::CARD_PROCESSOR_RESPONSE_PARTIAL_APPROVAL,
            self::CARD_PROCESSOR_RESPONSE_INVALID_TRANSACTION,
            self::CARD_PROCESSOR_RESPONSE_INVALID_AMOUNT,
            self::CARD_PROCESSOR_RESPONSE_INVALID_CARD_NUMBER,
            self::CARD_PROCESSOR_RESPONSE_CARD_SCHEME_NETWORK_CANNOT_CONNECT_TO_THREDD,
            self::CARD_PROCESSOR_RESPONSE_CUSTOMER_CANCELLATION,
            self::CARD_PROCESSOR_RESPONSE_FATAL_ERROR,
            self::CARD_PROCESSOR_RESPONSE_PARTIAL_REVERSAL,
            self::CARD_PROCESSOR_RESPONSE_EXPIRED_CARD_CAP,
            self::CARD_PROCESSOR_RESPONSE_SUSPECTED_FRAUD,
            self::CARD_PROCESSOR_RESPONSE_LOST_CARD_CAP,
            self::CARD_PROCESSOR_RESPONSE_STOLEN_CARD_CAP,
            self::CARD_PROCESSOR_RESPONSE_CLOSED_ACCOUNT,
            self::CARD_PROCESSOR_RESPONSE_INSUFFICIENT_FUNDS,
            self::CARD_PROCESSOR_RESPONSE_EXPIRED_CARD,
            self::CARD_PROCESSOR_RESPONSE_TRANSACTION_NOT_PERMITTED_TO_HOLDER,
            self::CARD_PROCESSOR_RESPONSE_TRANSACTION_NOT_PERMITTED_TO_TERMINAL,
            self::CARD_PROCESSOR_RESPONSE_EXCEEDED_WITHDRAW_AMOUNT_LIMIT,
            self::CARD_PROCESSOR_RESPONSE_SECURITY_VIOLATION,
            self::CARD_PROCESSOR_RESPONSE_EXCEEDED_WITHDRAWAL_FREQUENCY_LIMIT,
            self::CARD_PROCESSOR_RESPONSE_RESPONSE_RECEIVED_TOO_LATE,
            self::CARD_PROCESSOR_RESPONSE_HOLDER_TO_CONTACT_ISSUER,
            self::CARD_PROCESSOR_RESPONSE_ALLOWED_PIN_RETRIES_EXCEEDED,
            self::CARD_PROCESSOR_RESPONSE_ALLOWED_NUMBER_OF_PIN_TRIES_EXCEEDED,
            self::CARD_PROCESSOR_RESPONSE_ISSUER_DOES_NOT_PARTICIPATE_IN_THE_SERVICE,
            self::CARD_PROCESSOR_RESPONSE_CARD_IS_NOT_ACTIVE,
            self::CARD_PROCESSOR_RESPONSE_UNACCEPTABLE_PIN,
            self::CARD_PROCESSOR_RESPONSE_DOMESTIC_DEBIT_TRANSACTION_NOT_ALLOWED,
            self::CARD_PROCESSOR_RESPONSE_TIMEOUT_AT_IEM,
            self::CARD_PROCESSOR_RESPONSE_APPROVED_NON_FINANCIAL_OR_HOLD,
            self::CARD_PROCESSOR_RESPONSE_PIN_VALIDATION_NOT_POSSIBLE,
            self::CARD_PROCESSOR_RESPONSE_PURCHASE_AMOUNT_ONLY_NO_CASHBACK_ALLOWED,
            self::CARD_PROCESSOR_RESPONSE_CRYPTOGRAPHIC_FAILURE,
            self::CARD_PROCESSOR_RESPONSE_AUTHENTICATION_FAILURE,
            self::CARD_PROCESSOR_RESPONSE_ISSUER_INOPERATIVE,
            self::CARD_PROCESSOR_RESPONSE_CANT_ROUTE,
            self::CARD_PROCESSOR_RESPONSE_VIOLATION_OF_LAW,
            self::CARD_PROCESSOR_RESPONSE_DUPLICATE_TRANSMISSION,
            self::CARD_PROCESSOR_RESPONSE_SYSTEM_MALFUNCTION,
            self::CARD_PROCESSOR_RESPONSE_CVV_FAIL,
            self::CARD_PROCESSOR_RESPONSE_FORCE_STIP,
            self::CARD_PROCESSOR_RESPONSE_APPROVE_LOAD,
            self::CARD_PROCESSOR_RESPONSE_VERIFICATION_DATA_FAILED,
            self::CARD_PROCESSOR_RESPONSE_STRONG_CUSTOMER_AUTHENTICATION,
            self::CARD_PROCESSOR_RESPONSE_SCA_REQUIRED,
            self::CARD_PROCESSOR_RESPONSE_CVV2_FAILURE,
            self::CARD_PROCESSOR_RESPONSE_UNKNOWN_REASON,
        ];
    }
     ...
     * @return string[]
     */
    public static function getOriginTypeAllowableValues()
    {
        return [
    ...
    */
     ...
     *
     * @param \Shaype\Webhook\Model\CurrencyAmount|null $currency_amount The transaction amount and currency
     *
     * @return $this
     */
     ...
     *
     * @param \Shaype\Webhook\Model\CurrencyAmount|null $updated_balance Updated account balance after the transaction
     *
     * @return $this
     * @deprecated
     */
     ...
     *
     * @param \Shaype\Webhook\Model\CardUsageDetails|null $card_usage_details Details on the circumstances of card transaction
     *
     * @return $this
     */
     ...
     *
     * @param \Shaype\Webhook\Model\AccountBalancesDto|null $account_balances Breakdown of the account balances
     *
     * @return $this
     */
     ...
     * Sets rule_details
     *
     * @param \Shaype\Webhook\Model\RuleDetails|null $rule_details Details about the rule triggered that stopped the transaction
     *
     * @return $this
     */
     ...
     *
     * @param \Shaype\Webhook\Model\CounterpartDetails|null $counterpart_details Transaction counterpart details.
     *
     * @return $this
     */
     ...
     *
     * @param \Shaype\Webhook\Model\MandatePaymentDetails|null $mandate_payment_details Mandate payment details.
     *
     * @return $this
     */
     ...
     * Sets return_reason
     *
     * @param \Shaype\Webhook\Model\ReturnReason|null $return_reason Reason for a transaction reversal.
     *
     * @return $this
     */
