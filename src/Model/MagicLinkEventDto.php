...
/**
 * MagicLinkEventDto Class Doc Comment
 *
 ...
 */
class MagicLinkEventDto implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'MagicLinkEventDto';
    ...
    */
     ...
     * Sets magic_link
     *
     * @param string|null $magic_link Magic Link to be delivered to the customer
     *
     * @return $this
     */
    public function setMagicLink(?string $magic_link): static
    {
