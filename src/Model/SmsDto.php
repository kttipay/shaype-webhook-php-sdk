...
class SmsDto implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    */
     ...
     * Sets phone_number
     *
     * @param \Shaype\Webhook\Model\PhoneNumber $phone_number Phone number to send the SMS notification to.
     *
     * @return $this
     */
     ...
     *
     * @param \Shaype\Webhook\Model\PasscodeChangeEventDto|null $passcode_change_event Details of the **Passcode Change** event; provided when the type is `PASSCODE_CHANGE`.
     *
     * @return $this
     */
     ...
     *
     * @param \Shaype\Webhook\Model\PhoneNumberVerificationEventDto|null $phone_number_verification_event Details of the **Phone Number Verification** event; provided when the type is `PHONE_NUMBER_VERIFICATION`.
     *
     * @return $this
     */
     ...
     *
     * @param \Shaype\Webhook\Model\CustomerOtpEventDto|null $customer_otp_event Details of the **One-Time Password Request** event; provided when the type is `OTP`.
     *
     * @return $this
     */
