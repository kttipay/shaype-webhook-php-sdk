 ...
 */
class CounterpartDetails implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'CounterpartDetails';
    ...
    */
     ...
     * Sets account_id
     *
     * @param string|null $account_id Transaction counterpart account unique identifier (UUID)
     *
     * @return $this
     */
     ...
     * Sets customer_id
     *
     * @param string|null $customer_id Transaction counterpart customer unique identifier (UUID)
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string|null $name Transaction counterpart name.
     *
     * @return $this
     */
     ...
     * Sets bpay_details
     *
     * @param \Shaype\Webhook\Model\BpayDetails|null $bpay_details BPAY transaction counterpart details.
     *
     * @return $this
     */
     ...
     *
     * @param \Shaype\Webhook\Model\BasicAccountNumber|null $basic_account_number Details of the counterpart account number
     *
     * @return $this
     */
