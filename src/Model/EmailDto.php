...
class EmailDto implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    */
     ...
     *
     * @param \Shaype\Webhook\Model\CustomerDetails|null $customer_details Details of the customer - recipient of the email.
     *
     * @return $this
     */
     ...
     *
     * @param \Shaype\Webhook\Model\CardAdditionToWalletEventDto|null $card_addition_to_wallet_event Details of the **Card Status Change** event; provided when the type is `CARD_ADDED_TO_WALLET`.
     *
     * @return $this
     */
     ...
     *
     * @param \Shaype\Webhook\Model\CardPinChangeEventDto|null $card_pin_change_event Details of the **Card PIN Change** event; provided when the type is `CARD_PIN_CHANGE`.
     *
     * @return $this
     */
     ...
     *
     * @param \Shaype\Webhook\Model\MagicLinkEventDto|null $magic_link_event Details of the **Magic Link Email Request** event; provided when the type is `MAGIC_LINK`.
     *
     * @return $this
     */
