...
class NotificationDto implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        ...
        'delegated_otp_notification_event' => '\Shaype\Webhook\Model\DelegatedOtpNotificationEventDto'
    ];
    ...
    protected static array $openAPIFormats = [
        ...
        'delegated_otp_notification_event' => null
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'delegated_otp_notification_event' => false
    ];
    ...
    protected static array $attributeMap = [
        ...
        'delegated_otp_notification_event' => 'delegatedOtpNotificationEvent'
    ];
    ...
    protected static array $setters = [
        ...
        'delegated_otp_notification_event' => 'setDelegatedOtpNotificationEvent'
    ];
    ...
    protected static array $getters = [
        ...
        'delegated_otp_notification_event' => 'getDelegatedOtpNotificationEvent'
    ];
    ...
    public const TYPE_DELEGATED_OTP_NOTIFICATION = 'DELEGATED_OTP_NOTIFICATION';
    ...
    public static function getTypeAllowableValues()
    {
        return [
            ...
            self::TYPE_DELEGATED_OTP_NOTIFICATION,
        ];
    }
     ...
     * @return string[]
     */
    public static function getReminderTypeAllowableValues()
    {
        return [
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('delegated_otp_notification_event', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param \Shaype\Webhook\Model\AccountStatusChangeEventDto|null $account_status_change_event Details of the **Account Status Change** event; provided when the type is `ACCOUNT_STATUS_CHANGE`.
     *
     * @return $this
     */
     ...
     *
     * @param \Shaype\Webhook\Model\CustomerStatusUpdatedEventDto|null $customer_status_updated_event Details of the **Customer Status Updated** event; provided when the type is `CUSTOMER_STATUS_UPDATED`.
     *
     * @return $this
     */
     ...
     *
     * @param \Shaype\Webhook\Model\TransactionEventDto|null $transaction_event Details of the **Transaction** event; provided when the type is `TRANSACTION`.
     *
     * @return $this
     */
     ...
     *
     * @param \Shaype\Webhook\Model\CardStatusChangeEventDto|null $card_status_change_event Details of the **Card Status Change** event; provided when the type is `CARD_STATUS_CHANGE`.
     *
     * @return $this
     */
     ...
     *
     * @param \Shaype\Webhook\Model\CustomerDetailsChangeEventDto|null $customer_details_change_event Details of the **Customer Details Change** event; provided when the type is `CUSTOMER_DETAILS_CHANGE`.
     *
     * @return $this
     */
     ...
     *
     * @param \Shaype\Webhook\Model\CardAdditionToWalletEventDto|null $card_addition_to_wallet_event Details of the **Card Added to Wallet** event; provided when the type is `CARD_ADDED_TO_WALLET`.
     *
     * @return $this
     */
     ...
     *
     * @param \Shaype\Webhook\Model\ScheduledPaymentEventDto|null $scheduled_payment_event Details of the **Scheduled Payment Created** event; provided when the type is `SCHEDULED_PAYMENT`.
     *
     * @return $this
     */
     ...
     *
     * @param \Shaype\Webhook\Model\OnboardingFailedEventDto|null $onboarding_failed_event Details of the **Onboarding Failed** event; provided when the type is `ONBOARDING_FAILED`.
     *
     * @return $this
     */
     ...
     *
     * @param \Shaype\Webhook\Model\DirectEntryEventDto|null $direct_entry_event Details of the **Direct Entry** event; provided when the type is `DIRECT_ENTRY`.
     *
     * @return $this
     */
     ...
     *
     * @param \Shaype\Webhook\Model\MandateDuePaymentEventDto|null $mandate_due_payment_event_dto Details of the **Mandate Due Payment** event; provided when the type is `MANDATE_DUE_PAYMENT`.
     *
     * @return $this
     */
     ...
     *
     * @param \Shaype\Webhook\Model\MandateEventDto|null $mandate_event_dto Details of the **Mandate** event; provided when the type is `MANDATE`.
     *
     * @return $this
     */
     ...
     *
     * @param \Shaype\Webhook\Model\MandatePaymentEventDto|null $mandate_payment_event_dto Details of the **Mandate Payment** event; provided when the type is `MANDATE_PAYMENT`.
     *
     * @return $this
     */
     ...
     *
     * @param \Shaype\Webhook\Model\ApplePayRewardForCustomerEventDto|null $apple_pay_reward_for_customer_event Details of the **Apple Pay Reward For Customer** event; provided when the type is `APPLE_PAY_REWARD_FOR_CUSTOMER`.
     *
     * @return $this
     */
     ...
     *
     * @param \Shaype\Webhook\Model\CardExpiryReminderEventDto|null $card_expiry_reminder_event Details of the **Card About To Expire** event; provided when the type is `REMINDER` with one of the following reminder type values:  * **CARD_EXPIRY_MONTH_REMINDER**  * **CARD_EXPIRY_2_WEEK_REMINDER**  * **CARD_EXPIRY_DAY_REMINDER**
     *
     * @return $this
     */
     ...
     *
     * @param \Shaype\Webhook\Model\MandateActionExpirationEventDto|null $mandate_action_expiration_event Details of the **Mandate Action Expiration** event; provided when the type is `MANDATE_ACTION_EXPIRATION`.
     *
     * @return $this
     */
    ...
    /**
     * Gets delegated_otp_notification_event
     *
     * @return \Shaype\Webhook\Model\DelegatedOtpNotificationEventDto|null
     */
    public function getDelegatedOtpNotificationEvent(): ?\Shaype\Webhook\Model\DelegatedOtpNotificationEventDto
    {
        return $this->container['delegated_otp_notification_event'];
    }

    /**
     * Sets delegated_otp_notification_event
     *
     * @param \Shaype\Webhook\Model\DelegatedOtpNotificationEventDto|null $delegated_otp_notification_event Details of the **Delegated OTP Notification** event; provided when the type is `DELEGATED_OTP_NOTIFICATION`.
     *
     * @return $this
     */
    public function setDelegatedOtpNotificationEvent(?\Shaype\Webhook\Model\DelegatedOtpNotificationEventDto $delegated_otp_notification_event): static
    {
        if (is_null($delegated_otp_notification_event)) {
            throw new InvalidArgumentException('non-nullable delegated_otp_notification_event cannot be null');
        }
        $this->container['delegated_otp_notification_event'] = $delegated_otp_notification_event;
