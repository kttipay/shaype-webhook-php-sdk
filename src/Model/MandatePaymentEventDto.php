...
class MandatePaymentEventDto implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    public const PAYMENT_STATUS_MANDATE_PAYMENT_ACCEPTED = 'MANDATE_PAYMENT_ACCEPTED';
    public const PAYMENT_STATUS_MANDATE_PAYMENT_ACCEPTED_FOR_CLEARANCE = 'MANDATE_PAYMENT_ACCEPTED_FOR_CLEARANCE';
    public const PAYMENT_STATUS_MANDATE_PAYMENT_PENDING = 'MANDATE_PAYMENT_PENDING';
    public const PAYMENT_STATUS_MANDATE_PAYMENT_RECEIVED = 'MANDATE_PAYMENT_RECEIVED';
    public const PAYMENT_STATUS_MANDATE_PAYMENT_REJECTED = 'MANDATE_PAYMENT_REJECTED';
    public const PAYMENT_STATUS_MANDATE_PAYMENT_SENT = 'MANDATE_PAYMENT_SENT';
    public const PAYMENT_STATUS_MANDATE_PAYMENT_SETTLEMENT_ABORTED = 'MANDATE_PAYMENT_SETTLEMENT_ABORTED';
    public const PAYMENT_STATUS_MANDATE_PAYMENT_STORE_AND_FORWARD = 'MANDATE_PAYMENT_STORE_AND_FORWARD';
    public const PAYMENT_STATUS_MANDATE_PAYMENT_UNDELIVERED = 'MANDATE_PAYMENT_UNDELIVERED';
    ...
    {
        return [
            self::PAYMENT_STATUS_MANDATE_PAYMENT_ACCEPTED,
            self::PAYMENT_STATUS_MANDATE_PAYMENT_ACCEPTED_FOR_CLEARANCE,
            self::PAYMENT_STATUS_MANDATE_PAYMENT_PENDING,
            self::PAYMENT_STATUS_MANDATE_PAYMENT_RECEIVED,
            self::PAYMENT_STATUS_MANDATE_PAYMENT_REJECTED,
            self::PAYMENT_STATUS_MANDATE_PAYMENT_SENT,
            self::PAYMENT_STATUS_MANDATE_PAYMENT_SETTLEMENT_ABORTED,
            self::PAYMENT_STATUS_MANDATE_PAYMENT_STORE_AND_FORWARD,
            self::PAYMENT_STATUS_MANDATE_PAYMENT_UNDELIVERED,
        ];
    }
