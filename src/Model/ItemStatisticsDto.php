...
/**
 * ItemStatisticsDto Class Doc Comment
 *
 * @description Details of the **Bulk-Batch items count**
 * @package  Shaype\Webhook
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements ArrayAccess<string, mixed>
 */
class ItemStatisticsDto implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ItemStatisticsDto';
    ...
    */
     ...
     * Sets pending
     *
     * @param int|null $pending Total pending batch items.
     *
     * @return $this
     */
     ...
     * Sets success
     *
     * @param int|null $success Total successful batch items.
     *
     * @return $this
     */
     ...
     * Sets error
     *
     * @param int|null $error Total errored  batch items.
     *
     * @return $this
     */
     ...
     * Sets failed
     *
     * @param int|null $failed Total failure  batch items.
     *
     * @return $this
     */
