...
*NotificationsAPIApi* | [**notifyGenericNotification**](docs/Api/NotificationsAPIApi.md#notifygenericnotification) | **POST** /api/hay/v1/communications/notification | Generic Notification - event
...
- [BatchCompletedEventDto](docs/Model/BatchCompletedEventDto.md)
...
- [DelegatedOtpNotificationEventDto](docs/Model/DelegatedOtpNotificationEventDto.md)
- [DirectEntryEventDto](docs/Model/DirectEntryEventDto.md)
- [EmailDto](docs/Model/EmailDto.md)
- [EventDetailsDto](docs/Model/EventDetailsDto.md)
- [ItemStatisticsDto](docs/Model/ItemStatisticsDto.md)
...
- [MerchantInfoDto](docs/Model/MerchantInfoDto.md)
- [NotificationDto](docs/Model/NotificationDto.md)
- [NotificationDtoV1](docs/Model/NotificationDtoV1.md)
