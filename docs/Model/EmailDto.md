...
**customer_details** | [**\Shaype\Webhook\Model\CustomerDetails**](CustomerDetails.md) | Details of the customer - recipient of the email. | [optional]
**card_hay_id** | **string** | Unique identifier (UUID) of the Card associated with the event | [optional]
**card_addition_to_wallet_event** | [**\Shaype\Webhook\Model\CardAdditionToWalletEventDto**](CardAdditionToWalletEventDto.md) | Details of the **Card Status Change** event; provided when the type is &#x60;CARD_ADDED_TO_WALLET&#x60;. | [optional]
**card_pin_change_event** | [**\Shaype\Webhook\Model\CardPinChangeEventDto**](CardPinChangeEventDto.md) | Details of the **Card PIN Change** event; provided when the type is &#x60;CARD_PIN_CHANGE&#x60;. | [optional]
...
**magic_link_event** | [**\Shaype\Webhook\Model\MagicLinkEventDto**](MagicLinkEventDto.md) | Details of the **Magic Link Email Request** event; provided when the type is &#x60;MAGIC_LINK&#x60;. | [optional]
